...
void push(string barang, int berat, string kota)
{
    kirim.top++;
    kirim.jenis_brg[kirim.top]=barang;
...
int main ()
{
    ...
    do{
        ...
        bersihlayar();
        gotoxy(1,1);cout<<"MENU UTAMA"<<endl;
        gotoxy(1,2);cout<<"1. Tambah Data"<<endl;
        gotoxy(1,3);cout<<"2. Hapus Data Terakhir"<<endl;
        gotoxy(1,4);cout<<"3. Tampil Data"<<endl;
        gotoxy(1,5);cout<<"4. Clear Data"<<endl;
        ...
        switch(pilih)
        {
            ...
            case 2:
            {
                ...
                {
                    gotoxy(40,12);cout<<"Data yang anda Hapus Adalah :"<<endl;
                    gotoxy(40,13);cout<<kirim.jenis_brg[kirim.top]<<" ";
                    gotoxy(40,14);cout<<kirim.berat[kirim.top]<<" Kg ";
                    gotoxy(40,15);cout<<kirim.kota[kirim.top]<<endl<<endl;
                    pop();
                }
                cout<<endl;
                getchar();
